...
<script src="${path}/js/jquery/jquery-1.11.1.min.js"
...
<!-- 引用Easy UI 修订过的Js文件 -->
<script src="${path}/js/easyui/jquery.easyui.min.js"
	type="text/javascript"></script>
<!-- 引用EasyUI的国际化文件,让它显示中文 -->
<script src="${path}/js/easyui/locale/easyui-lang-zh_CN.js"
	type="text/javascript"></script>
<!-- 引入easyui扩展 -->
...
<!-- 导入Easy UI的主题Css文件 -->
<link id="easyuiTheme"
	href="${path}/js/easyui/themes/default/easyui.css" rel="stylesheet"
	type="text/css" />

<!-- 导入Easy UI的图标Css文件 -->
<link href="${path}/js/easyui/themes/icon.css" rel="stylesheet"
	type="text/css" />
