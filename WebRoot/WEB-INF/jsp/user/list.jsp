	...
	<div region="center" border="false" style="overflow: hidden;">
		...
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" method="post" novalidate>
				...
				<div class="fitem">
					<label>性别:</label> <input type="radio" name="gender" id="gender"
						value="男" style="width: 50px;">男</input> <input type="radio"
						name="gender" id="gender" value="女" style="width: 50px;">女</input>
				</div>
				<div class="fitem">
					<label>入职时间:</label> <input name="regtime" type="text"
			...
			<form id="fmsearch" method="post" novalidate>
				...
				<div class="fitem">
					<label>性别:</label> <input type="radio" name="gender" id="gender"
						...
						name="gender" id="gender" value="男" style="width: 30px;">男</input>
					<input type="radio" name="gender" id="gender" value="女"
						style="width: 30px;">女</input>
				</div>
				<div class="fitem">
					<label>入职时间:</label> <input name="regtime" type="text"
				...
				<div class="fitem">
					<label>至</label> <input name="regtime" type="text"
						class="easyui-datebox" />
				</div>
				<div class="fitem">
					<label>Email:</label> <input name="email" class="easyui-textbox">
