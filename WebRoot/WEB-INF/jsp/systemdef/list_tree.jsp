...
<script src="${path}/js/assets/systemdef_list_treegrid.js"
	type="text/javascript"></script>
</head>
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		<!-- 信息列表 title="菜单管理" -->
		<table id="systemdef-treegrid" class="easyui-treegrid" fit="true"
			nowrap="false" fitColumns="true" singleSelect="true"
			rownumbers="true"
